...
class linkedClass {
    ...
    public function linkedinGetUserInfo( $requestToken='', $oauthVerifier='', $accessToken=''){
        ...
        try{
            $xml_response = $linkedin->getProfile("~:(id,first-name,last-name,interests,publications,patents,languages,skills,date-of-birth,email-address,phone-numbers,im-accounts,main-address,twitter-accounts,headline,picture-url,public-profile-url,positions)");
        }
        catch (Exception $o){
            print_r($o);
        }
